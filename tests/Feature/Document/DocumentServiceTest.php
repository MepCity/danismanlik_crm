...
it('compensates object storage when the database transaction fails', function (): void {
    ...
    {
        public function record(string $action, array $payload, ?int $actorId = null, ?int $leadId = null, ?int $dealId = null, ?int $dealDocumentId = null, ?Carbon $occurredAt = null, ?string $defaultSource = null): void
        {
