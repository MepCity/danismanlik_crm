...
final class ReferenceDataSeeder extends Seeder
{
    ...
    private const ROLES = [
        'Pazarlama' => [
            'scope' => 'own',
            'permissions' => [
                'company.manage', 'lead.manage', 'deal.create', 'deal.view_own',
                'audit.view_own',
            ],
        ],
        'Proje Yöneticisi' => [
            'scope' => 'team',
            'permissions' => [
                'company.manage', 'deal.transition', 'deal.view_team',
                'document.upload', 'document.approve', 'document.download',
                'audit.view_team',
            ],
        ],
        'Şirket Yetkilisi' => [
            'scope' => 'all',
            'permissions' => [
                'company.manage', 'lead.manage', 'deal.create', 'deal.assign',
                'deal.transition', 'deal.view_all', 'deal.amount.view',
                'document.upload', 'document.approve', 'document.download',
                'program.manage', 'audit.view_all',
            ],
        ],
        'Sistem Yöneticisi' => [
            'scope' => 'none',
            'permissions' => [
                'company.manage', 'lead.manage', 'deal.create', 'deal.assign',
                'deal.transition', 'document.upload', 'document.approve',
                'program.manage', 'audit.view_all', 'system.users', 'system.roles',
