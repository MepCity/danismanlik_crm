...
| ☐ Açık | Müşteri portalı v1'de mi, sonra mı? | Dış kullanıcı izolasyonu ve test yükü kapsamı yaklaşık %25 büyütür. | Şirket Yetkilisi + ürün sahibi | PLAN kararı uygulanır: portal v1 dışında kalır. | Faz/karar: ____ Onay: ____ |
