...
final readonly class SubjectReference
{
    ...
    /** @return array{company_id: int|null, program_id: int|null, lead_id: int|null, deal_id: int|null, deal_document_id: int|null} */
    public function columns(): array
    {
        return [
            'company_id' => $this->type === CollaborationSubjectType::Company ? $this->id : null,
            'program_id' => $this->type === CollaborationSubjectType::Program ? $this->id : null,
