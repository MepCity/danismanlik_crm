...
final readonly class CollaborationTransaction
{
    ...
    public function run(ActorSource $source, ?int $actorId, Closure $callback): mixed
    {
        ...
        return $this->actors->runWith(
            new Actor($source, $actorId === null ? null : (string) $actorId),
    ...
    {
        $values = $actor === null
            ? ['app.source' => 'system', 'app.actor_id' => '', 'app.session_id' => '', 'app.client_ip' => '']
            : [
