...
**Modül ve tasarım eşleme yöntemi — müşteri kararı, 02.09.2026:** Ürünün bilgi mimarisi Cubicl'den kopyalanmaz; Bizlife'ın onaylı dar kapsamından gelir. İş Akışları, Hizmetler, Firmalar, türetilmiş Müşteriler görünümü, Takip Panosu/Dosyalar ve kullanıcı tarafından daha sonra onaylanacak diğer modüller korunur. Her ekran uygulanmadan önce Cubicl'de aynı işi veya en yakın çalışma biçimini yapan ekran aranır. Uygun karşılık varsa sayfa iskeleti, bileşen geometrisi, yoğunluk, kontrol yerleşimi ve etkileşim davranışı o referansa yakın uyarlanır; Bizlife alanları ve iş kuralları korunur. Cubicl'de karşılık yoksa ekran, mevcut Cubicl tabanlı tokenlar ve daha önce kabul edilmiş Bizlife bileşenleriyle sıfırdan tasarlanır. Böylece özellik kapsamını Bizlife, görsel ve etkileşim dilini Cubicl belirler. Cubicl'de bir özelliğin bulunması tek başına onu ürün kapsamına almaz.
...
|---|---|---|
| 1.29 | 02.09.2026 | Bizlife modül şeması ile Cubicl tasarım referansının sınırı kesinleştirildi: özellik kapsamını İş Akışları, Hizmetler, Firmalar, Müşteriler ve Takip Panosu/Dosyalar gibi onaylı Bizlife modülleri belirler; Cubicl'de uygun ekran varsa yakın uyarlanır, yoksa aynı token ve bileşen diliyle yeni ekran tasarlanır |
